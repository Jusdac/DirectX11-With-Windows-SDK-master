...
void GameApp::UpdateScene(float dt)
{
    ...
    if (ImGui::Begin("Lighting"))
    {
        ...
        //m_PSConstantBuffer.material.ambient.x = 1.0f;
        //m_PSConstantBuffer.material.ambient.y = 0.0f;
        //m_PSConstantBuffer.material.ambient.z = 0.0f;
        //m_PSConstantBuffer.material.ambient.w = 1.0f;
...
void GameApp::DrawScene()
{
    ...
    //m_pd3dImmediateContext->DrawIndexed(m_IndexCount, 0, 0);
    //m_pd3dImmediateContext->RSSetState(m_pRSWireframeSolid.Get());
    //m_pd3dImmediateContext->DrawIndexed(m_IndexCount, 0, 0);
...
bool GameApp::InitResource()
{
    ...
    D3D11_RASTERIZER_DESC rasterizerDescSolid;
    ZeroMemory(&rasterizerDescSolid, sizeof(rasterizerDescSolid));
    rasterizerDescSolid.FillMode = D3D11_FILL_SOLID;
    rasterizerDescSolid.CullMode = D3D11_CULL_NONE;
    rasterizerDescSolid.FrontCounterClockwise = false;
    rasterizerDescSolid.DepthClipEnable = true;
    HR(m_pd3dDevice->CreateRasterizerState(&rasterizerDescSolid, m_pRSWireframeSolid.GetAddressOf()));
